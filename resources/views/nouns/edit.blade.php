       ...
       <form action="{{ route('nouns.update', $noun) }}" method="POST">
            ...
            <div class="flex flex-wrap mb-6">
                <div class="w-full md:w-[200px] mb-6 md:mb-0">
                    ...
                    <input readonly class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="word" name="word" type="text" placeholder="Word" value="{{ old('word', $noun->word) }}">
                </div>
                ...
                <div class="w-full md:w-[200px] px-3 mb-6 md:mb-0">
                    ...
                    <select class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="difficulty" name="difficulty">
                        ...
                        <option value="hard" {{ old('difficulty', $noun->difficulty == 'hard') ? 'selected' : '' }}>Hard</option>
                    </select>
                </div>
            </div>
